...
#define KPD_MULTIPLE_SCAN

//#define KPD_OSCILLOSCOPE_DEBUG
//#define KPD_OSCILLOSCOPE_DEBUG_PIN A2
...
public:
	...
	Keypad(char *userKeymap, byte cpin, byte rpin, byte vpin, byte numRowBits, byte numRows, byte numCols);
...
private:
	...
	char *keymap;
    byte countPin, resetPin, valuePin;
	KeypadSize sizeKpd;
	uint debounceTime;
	uint holdTime;
	bool single_key;
